...
import tuleuov.space.railway.service.AuthenticationService;
...
public class AuthController {
    ...
    @PostMapping("/sign-up")
    public JwtAuthenticationResponseWithUserData signUp(@RequestBody @Valid SignUpRequest request) {
        return authenticationService.signUp(request);
    }

    @Operation(summary = "Авторизация пользователя")
    @PostMapping("/sign-in")
    public JwtAuthenticationResponseWithUserData signIn(@RequestBody @Valid SignInRequest request) {
